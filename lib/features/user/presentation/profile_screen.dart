...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        // SafeArea avoids notches and system UI overlaps on Android devices.
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            return SingleChildScrollView(
              // SingleChildScrollView prevents vertical overflow on small screens.
                  ...
                  if (user.skills.isEmpty)
                    ...
                    GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        // Switch to 2 columns on wider screens for better scaling.
